        ...
        <div className="row">
            <div className="col-sm-5 p-3">
                <form onSubmit={submitRecords}>
                    ...
                    <label htmlFor="" className='label-control'>Your Task</label>
                    <textarea ref={taskRef} className='form-control' name="" id="" cols="30" rows="5"></textarea>
                    <div className='pt-3'>
                        <div className="row">
                            <div className="col-3">
                                <button type='submit' className='btn btn-primary' style={{ backgroundColor: "#8a98ff", borderColor: "#8a98ff" }}>Save Task</button>
                            </div>
                        </div>
                    </div>
                </form>
