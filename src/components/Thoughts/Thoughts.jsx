        ...
        <div className="row">
            <div className="col-sm-5 p-3">
                <form onSubmit={submitRecords}>
                    <label htmlFor="" className='label-control'>Select Date</label>
                    <div className="col-7 pb-3">
                        <div className="input-group date" id="">
                            <input ref={dateRef} type="date" className="form-control" id="date"/>
                        </div>
                    </div>
                    <label htmlFor="" className='label-control'>What's on your mind</label>
                    <textarea ref={taskRef} className='form-control' name="" id="" cols="30" rows="5"></textarea>
                    <div className='pt-3'>
                        <div className="row">
                            <div className="col-5">
                                <button type='submit' className='btn btn-primary' style={{ backgroundColor: "#fb87ff", borderColor: "#fb87ff" }}>Save your thoughts</button>
                            </div>
                        </div>
                    </div>
                </form>
